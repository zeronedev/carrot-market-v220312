    ...
    <div className="py-10 px-4 space-y-4 ">
      ...
      <div className="mt-5">
        ...
        <p className="my-6 text-gray-700">
          ...
          살아있는 밤 사진을 찍을 수 있답니다.어둡다고 촬영을 포기하셨다면, 이젠
          포기하지 마세요. 동영상 촬영에 획기적인 도약을 이룬 나이토그래피.
          조도에 맞춰 최적의 프레임 속도로 자동 조정되어 동영상을 더 밝게 촬영해
          줍니다. 프레임의 노이즈를 제거하는 수퍼 나이트 솔루션을 탑재한 4 nm
          프로세서니까. 태양 아래서든, 별빛 아래서든 고화질의 생생한 영상을
          촬영해 보세요.
        </p>
      </div>
