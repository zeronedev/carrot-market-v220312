  ...
  return (
    <div className="grid min-h-screen gap-10 bg-slate-400 py-10 px-20">
      <div className="rounded-3xl bg-white p-6 shadow-xl">
        ...
        <button className="mx-auto mt-5 w-2/4 rounded-xl bg-blue-500  p-3 text-center text-white hover:bg-teal-500 hover:text-black focus:bg-red-500 active:bg-yellow-500">
          Checkout
        </button>
      </div>
